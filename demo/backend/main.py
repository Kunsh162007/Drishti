...
# Heavy analytics default responses are precomputed at build time and bundled as static
# JSON (demo/data/precomputed/), served directly by the endpoints — no per-request compute,
# no 25k-row loads, no OOM. So no runtime cache-warming is needed here.
